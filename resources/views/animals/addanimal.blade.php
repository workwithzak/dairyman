    ...
    <div class="w3-col m5">
      ...
      <div class="w3-card w3-white">
        <div class="w3-container">
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i>Add animal</p>
        <hr>
        <!--- add animal form start--->
           
            <form action="{{route('addanimal')}}" method ="post" style="max-width:500px;margin:auto">
            @csrf
             ...
             @enderror
            <div class="input-container @error('name') w3-border w3-border-red @enderror">
